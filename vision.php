...
<?php include("navbar.php");?>
    ...
    <section id="visionmission" class="section-bg">
	<div class="section-title">
		<h1>Vision <span>and</span> Mission</h1>
	</div>
...
<!-- ======= Vision Mission Section ======= -->
	...
	<p>We believe it is essential for all employees to understand and embrace our vision and mission. We build our success around our reputation for adhering to the highest standards of safety, quality, and integrity.</p>
	</div>
